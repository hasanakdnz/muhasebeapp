...
INSERT INTO "new_CekSenet" ("aciklama", "cariId", "ciroEdilenCariId", "ciroTarihi", "createdAt", "durum", "id", "tahsilEdilen", "tip", "tutar", "updatedAt", "vadeTarihi", "yon") SELECT "aciklama", "cariId", "ciroEdilenCariId", "ciroTarihi", "createdAt", "durum", "id", "tahsilEdilen", "tip", "tutar", "updatedAt", "vadeTarihi", "yon" FROM "CekSenet";
DROP TABLE "CekSenet";
...
CREATE INDEX "CekSenet_tarih_idx" ON "CekSenet"("tarih");

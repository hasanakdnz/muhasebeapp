...
INSERT INTO "new_Cari" ("adres", "aktif", "bakiye", "createdAt", "email", "id", "telefon", "tip", "unvan", "updatedAt", "vergiDairesi", "vknTckn") SELECT "adres", "aktif", "bakiye", "createdAt", "email", "id", "telefon", "tip", "unvan", "updatedAt", "vergiDairesi", "vknTckn" FROM "Cari";
DROP TABLE "Cari";
